...
<body>
    ...
    <div class="container">
        <div class="header-section">
            ...
            <?php if(request('filter') === 'surat_mitra'): ?>
        ...
        <div class="table-container">
            <div class="table-wrapper">
                <table>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $pendaftarans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $pendaftaran): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td><?php echo e($loop->iteration); ?></td>
                                <td><strong><?php echo e($pendaftaran->nama_lengkap); ?></strong></td>
                                <td><?php echo e($pendaftaran->asal_sekolah); ?></td>
                                <td><?php echo e($pendaftaran->jurusan); ?></td>
                                <td><?php echo e($pendaftaran->email); ?></td>
                                <td><?php echo e($pendaftaran->tanggal_mulai_pkl); ?></td>
                                <td><?php echo e($pendaftaran->tanggal_selesai_pkl); ?></td>
                                <td>
                                    <span class="status-<?php echo e($pendaftaran->status); ?>">
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <a href="<?php echo e(route('admin.pendaftarans.show', $pendaftaran->id)); ?>" class="btn-detail">Detail</a>
                                        
                                        <?php if($pendaftaran->status == 'approved'): ?>
                                        <form action="<?php echo e(route('admin.pendaftarans.complete', $pendaftaran->id)); ?>" method="POST" style="display:inline;">
                                            <?php echo csrf_field(); ?>
                                            <button type="submit" class="btn-complete" onclick="showCompleteModal(event, '<?php echo e($pendaftaran->nama_lengkap); ?>', '<?php echo e($pendaftaran->asal_sekolah); ?>', '<?php echo e($pendaftaran->id); ?>')">Selesai</button>
                                        </form>
                                        <?php endif; ?>

                                        <form action="<?php echo e(route('admin.pendaftarans.destroy', $pendaftaran->id)); ?>" method="POST" style="display:inline;">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('DELETE'); ?>
                                            <button type="submit" class="btn-delete" onclick="showDeleteModal(event, '<?php echo e($pendaftaran->nama_lengkap); ?>', '<?php echo e($pendaftaran->asal_sekolah); ?>', '<?php echo e(ucfirst($pendaftaran->status)); ?>', '<?php echo e($pendaftaran->id); ?>')">Hapus</button>
                                        </form>
                                    </div>
                                </td>
                            </tr>
...
<?php /**PATH C:\laravel\PKL BPS TEGAL\resources\views/admin/pendaftarans/index.blade.php ENDPATH**/ ?>
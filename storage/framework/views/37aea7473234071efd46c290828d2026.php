...
<body>
    <div class="navbar">
        <div class="navbar-content">
            ...
            <a href="<?php echo e(route('admin.alumni_pkl.index')); ?>" class="back-btn">Kembali</a>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="form-section">
            ...
            <form method="POST" action="<?php echo e(route('admin.alumni_pkl.store')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>

                <div class="form-group">
                    <label for="nama_lengkap" class="form-label">Nama Lengkap *</label>
                    <input type="text" id="nama_lengkap" name="nama_lengkap" class="form-input" required
                           placeholder="Masukkan nama lengkap alumni" value="<?php echo e(old('nama_lengkap')); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="universitas" name="universitas" class="form-input" required
                           placeholder="Masukkan nama universitas" value="<?php echo e(old('universitas')); ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="file-input-wrapper">
                        ...
                        <label for="foto" class="file-input-label">
                            ...
                            <img src="<?php echo e(asset('image/camera.png')); ?>" class="file-icon" alt="Camera Icon">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="button-group">
                    <a href="<?php echo e(route('admin.alumni_pkl.index')); ?>" class="btn btn-secondary">Batal</a>
...
</html><?php /**PATH C:\laravel\PKL BPS TEGAL\resources\views/admin/alumni_pkl/create.blade.php ENDPATH**/ ?>
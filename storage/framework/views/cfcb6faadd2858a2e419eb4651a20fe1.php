...
<body>
    <div class="container">
        ...
        <div class="upload-card">
            <form action="<?php echo e(route('upload.surat.tanda.tangan.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="form-group">
                    ...
                    <?php $__errorArgs = ['surat_tanda_tangan'];
            ...
            <div class="table-card">
                ...
                <div class="table-wrapper">
                    <table>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $suratUploads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $surat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($index + 1); ?></td>
                                    <td><?php echo e($surat->file_name); ?></td>
                                    <td><?php echo e(strtoupper($surat->file_type)); ?></td>
                                    <td><?php echo e($surat->file_size); ?> KB</td>
                                    <td><?php echo e($surat->created_at->format('d/m/Y H:i')); ?></td>
                                    <td>
                                        <a href="<?php echo e(Storage::url($surat->file_path)); ?>" target="_blank" class="btn-view">
                                             Lihat
                                        </a>
                                    </td>
                                </tr>
...
</html><?php /**PATH C:\laravel\PKL BPS TEGAL\resources\views/pendaftaran/upload_surat_tanda_tangan.blade.php ENDPATH**/ ?>
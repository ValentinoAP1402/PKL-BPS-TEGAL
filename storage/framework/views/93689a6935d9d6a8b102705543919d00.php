...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(asset('image/bps.png')); ?>" type="image/x-icon">
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body class="antialiased">
    ...
    <nav id="navbar" class="px-4 py-4">
        <div class="container mx-auto flex items-center justify-between px-4">
            <div class="flex items-center space-x-4">
                <a href="<?php echo e(route('home')); ?>" class="text-white text-2xl font-bold tracking-wide">
                    <img src="<?php echo e(asset('image/bps.png')); ?>" alt="BPS" class="h-8 w-8 inline mr-2"> BPS PKL
                </a>
            </div>
            ...
            <div class="nav-menu" id="navMenu">
                <a href="<?php echo e(route('informasi')); ?>" class="nav-link">Informasi PKL</a>
                <?php if(Auth::check() && (!$hasPendaftaran || $pendaftaranStatus !== 'approved')): ?>
                    <a href="<?php echo e(route('pendaftaran.create')); ?>" class="nav-link">Daftar Sekarang</a>
                    <a href="<?php echo e($hasPendaftaran ? route('upload.surat.tanda.tangan') : 'javascript:void(0)'); ?>" class="nav-link" onclick="<?php echo e(!$hasPendaftaran ? "showRegistrationAlert('upload'); return false;" : ''); ?>">Upload Surat</a>
                    <a href="<?php echo e($hasPendaftaran ? route('pendaftaran.surat_mitra_signed') : 'javascript:void(0)'); ?>" class="nav-link relative" onclick="<?php echo e(!$hasPendaftaran ? "showRegistrationAlert('surat_mitra'); return false;" : ''); ?>">
                        Surat Balasan
                        <?php if($suratMitraNotification): ?>
                    ...
                    <a href="<?php echo e(route('profile')); ?>" class="nav-link flex items-center justify-center">
                        <?php if(Auth::user()->avatar): ?>
                            <?php if(strpos(Auth::user()->avatar, 'http') === 0): ?>
                                <img src="<?php echo e(Auth::user()->avatar); ?>" alt="Profile" class="w-8 h-8 rounded-full border-2 border-white">
                            <?php else: ?>
                                <img src="<?php echo e(asset('storage/' . Auth::user()->avatar)); ?>" alt="Profile" class="w-8 h-8 rounded-full border-2 border-white">
                            <?php endif; ?>
                        <?php else: ?>
                            <img src="https://via.placeholder.com/32?text=P" alt="Profile" class="w-8 h-8 rounded-full border-2 border-white">
                        <?php endif; ?>
                    </a>
                <?php elseif(Auth::check() && $pendaftaranStatus === 'approved'): ?>
                    <a href="<?php echo e(route('upload.surat.tanda.tangan')); ?>" class="nav-link">Upload Surat</a>
                    <a href="<?php echo e(route('pendaftaran.surat_mitra_signed')); ?>" class="nav-link relative">
                        Surat Balasan
                        <?php if($suratMitraNotification): ?>
                            <span class="absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full w-3 h-3 flex items-center justify-center animate-pulse"></span>
                        <?php endif; ?>
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('auth.google')); ?>" class="nav-link">Login</a>
                <?php endif; ?>
            </div>
        </div>
    </nav>
    ...
    <header class="hero-section">
        ...
        <div id="bpsCarousel">
            <div class="slides">
                <div class="slide"><img src="<?php echo e(asset('images/slide1.jpg')); ?>" alt="Slide 1" loading="lazy" onerror="this.onerror=null;this.src='<?php echo e(asset('image/bps depan.jpg')); ?>';"></div>
                <div class="slide"><img src="<?php echo e(asset('images/slide2.jpg')); ?>" alt="Slide 2" loading="lazy" onerror="this.onerror=null;this.src='<?php echo e(asset('image/hsn.jpg')); ?>';"></div>
                <div class="slide"><img src="<?php echo e(asset('images/slide3.jpg')); ?>" alt="Slide 3" loading="lazy" onerror="this.onerror=null;this.src='<?php echo e(asset('image/bps depan.jpg')); ?>';"></div>
            </div>
    ...
    <section class="kuota-section">
        <div class="container mx-auto px-6">
            ...
            <div class="kuota-grid">
                <?php $__empty_1 = true; $__currentLoopData = $kuotas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kuota): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="kuota-card animate-fade-in-up">
                        <div class="kuota-card-title">
                            <?php echo e($kuota->bulan); ?>

                        </div>
                        <div class="kuota-card-info">Kuota Tersisa:</div>
                        <div class="kuota-card-number"><?php echo e($kuota->available_slots); ?></div>
                        <div class="kuota-card-info">dari <?php echo e($kuota->jumlah_kuota); ?> total kuota</div>
                        <?php if($kuota->available_slots == 0): ?>
                            <span class="kuota-status full">Kuota Penuh</span>
                        <?php elseif($kuota->available_slots <= 5): ?>
            ...
            <div class="relative">
                ...
                <div class="alumni-grid-wrapper py-4" id="alumniSlider">
                    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4" id="alumniTrack">
                        <?php $__currentLoopData = $alumni ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $alumnus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="alumni-slide">
                            <div class="alumni-card bg-white rounded-xl overflow-hidden transform hover:scale-110 hover:-translate-y-2 transition-all duration-300 group cursor-pointer shadow-xl border-2 border-gray-300 hover:border-purple-400" style="box-shadow: 0 4px 20px rgba(0, 0, 0, 0.15);">
                                <div class="alumni-image-container relative overflow-hidden" style="height: 256px;">
                                    <img src="<?php echo e(asset('storage/' . $alumnus->foto)); ?>" alt="<?php echo e($alumnus->nama_lengkap); ?>" class="alumni-image w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
                                    ...
                                    <div class="absolute bottom-0 left-0 right-0 p-4">
                                        <h3 class="text-white text-base font-bold mb-1 line-clamp-2 drop-shadow-lg"><?php echo e($alumnus->nama_lengkap); ?></h3>
                                        <p class="text-gray-200 text-xs font-semibold line-clamp-1" style="text-shadow: 2px 2px 4px rgba(0,0,0,0.8);"><?php echo e($alumnus->universitas); ?></p>
    ...
    <footer class="text-gray-300 py-16 mt-20">
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
                <div>
                    <h3 class="text-2xl font-bold text-white mb-4"><img src="<?php echo e(asset('image/bps.png')); ?>" alt="BPS PKL" class="h-8 w-8 inline mr-2"> Pendaftaran PKL BPS</h3>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="<?php echo e(route('informasi')); ?>" class="text-gray-400 hover:text-white transition duration-300 flex items-center">→ Informasi PKL</a></li>
                    </ul>
                </div>
            </div>
    ...
    <div id="successAlert" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 opacity-0 pointer-events-none transition-all duration-300">
        <div class="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg border border-white border-opacity-20 rounded-2xl p-8 max-w-md mx-4 shadow-2xl transform scale-95 transition-all duration-300">
            <div class="text-center">
                ...
                <p class="text-white text-opacity-90 leading-relaxed"><?php echo e(session('success')); ?></p>
    ...
    <div id="errorAlert" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 opacity-0 pointer-events-none transition-all duration-300">
        <div class="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg border border-white border-opacity-20 rounded-2xl p-8 max-w-md mx-4 shadow-2xl transform scale-95 transition-all duration-300">
            <div class="text-center">
                ...
                <p class="text-white text-opacity-90 leading-relaxed"><?php echo e(session('error')); ?></p>
...
<?php /**PATH C:\laravel\PKL BPS TEGAL\resources\views/home.blade.php ENDPATH**/ ?>
...
<body>
    <div class="container">
        <div class="header-card">
            ...
            <a href="<?php echo e(route('home')); ?>" class="btn-home">Kembali ke Beranda</a>
        </div>
            ...
            <?php if($pendaftaran->surat_balasan_pkl): ?>
                <div class="surat-balasan-card">
                    ...
                    <div class="balasan-content">
                        ...
                        <div class="balasan-filename">Surat Balasan PKL - <?php echo e($pendaftaran->nama_lengkap); ?></div>
                        <div class="balasan-meta">Diupload oleh Admin BPS</div>
                    </div>
                    <div class="balasan-actions">
                        <a href="<?php echo e(Storage::url($pendaftaran->surat_balasan_pkl)); ?>" target="_blank" class="btn-balasan btn-view-balasan">
                             Lihat
                        </a>
                        <a href="<?php echo e(Storage::url($pendaftaran->surat_balasan_pkl)); ?>" download class="btn-balasan btn-download-balasan">
                             Download
                        </a>
                    </div>
                </div>
        ...
        <?php if($suratUploads->whereNotNull('surat_mitra_signed')->count() > 0): ?>
            ...
            <div class="stats-card">
                <div class="stats-item">
                    ...
                    <div class="stats-content">
                        <div class="stats-number"><?php echo e($suratUploads->whereNotNull('surat_mitra_signed')->count()); ?></div>
            ...
            <div class="surat-grid">
                <?php $__currentLoopData = $suratUploads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $surat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($surat->surat_mitra_signed): ?>
                        <div class="surat-card">
                            <div class="surat-header">
                                <div class="surat-info">
                                    <div class="surat-name"><?php echo e($surat->file_name); ?></div>
                                    <div class="surat-date"><?php echo e($surat->created_at->format('d M Y H:i')); ?></div>
                                </div>
                            ...
                            <div class="surat-actions">
                                <a href="<?php echo e(Storage::url($surat->surat_mitra_signed)); ?>" target="_blank" class="btn-action btn-view">
                                     Lihat
                                </a>
                                <a href="<?php echo e(Storage::url($surat->surat_mitra_signed)); ?>" download class="btn-action btn-download">
                                     Download
                                </a>
                            </div>
                        </div>
...
</html><?php /**PATH C:\laravel\PKL BPS TEGAL\resources\views/pendaftaran/surat_mitra_signed.blade.php ENDPATH**/ ?>
...
<body>
    <div class="navbar">
        <div class="navbar-content">
            ...
            <a href="<?php echo e(route('admin.kuotas.index')); ?>" class="back-link">Kembali</a>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="form-container">
            ...
            <form action="<?php echo e(route('admin.kuotas.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <input 
                            ...
                            id="bulan" 
                            name="bulan" 
                            value="<?php echo e(old('bulan')); ?>" 
                            placeholder="Contoh: Januari 2024"
                            class="<?php $__errorArgs = ['bulan'];
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <input
                            ...
                            id="jumlah_kuota"
                            name="jumlah_kuota"
                            value="<?php echo e(old('jumlah_kuota')); ?>"
                            placeholder="Masukkan jumlah kuota"
                            min="1"
                            class="<?php $__errorArgs = ['jumlah_kuota'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> has-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="button-group">
                    ...
                    <a href="<?php echo e(route('admin.kuotas.index')); ?>" class="btn-cancel">
                        Batal
                    </a>
                </div>
            </form>
...
</html><?php /**PATH C:\laravel\PKL BPS TEGAL\resources\views/admin/kuotas/create.blade.php ENDPATH**/ ?>
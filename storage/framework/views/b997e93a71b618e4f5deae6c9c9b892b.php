    ...
    <div class="container">
        ...
        <div class="table-container">
            <table>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $allUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td><?php echo e($loop->iteration); ?></td>
                            <td><strong><?php echo e($item['name']); ?></strong></td>
                            <td><?php echo e($item['email']); ?></td>
                            <td>
                                <span class="role-badge role-<?php echo e($item['type']); ?>">
                                    <?php echo e(ucfirst($item['type'])); ?>

                                </span>
                            </td>
                            <td>
                                <span class="role-badge role-<?php echo e($item['role']); ?>">
                            ...
                            <td>
                                <div class="action-buttons">
                                    <?php if($item['type'] === 'user'): ?>
                                        <form action="<?php echo e(route('admin.user_roles.update_user', $item['id'])); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                        ...
                                        <button type="button" class="btn-delete" onclick="confirmDelete('<?php echo e($item['id']); ?>', '<?php echo e($item['name']); ?>', 'user')">Hapus</button>
                                    <?php else: ?>
                                        <form action="<?php echo e(route('admin.user_roles.update_admin', $item['id'])); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PUT'); ?>
                                            <select name="role" required>
                                                <option value="admin" <?php echo e($item['role'] === 'admin' ? 'selected' : ''); ?>>Admin</option>
                                        ...
                                        <?php if($item['model']->status === 'pending'): ?>
                                            <form action="<?php echo e(route('admin.user_roles.approve_admin', $item['id'])); ?>" method="POST" style="display: inline;">
                                                <?php echo csrf_field(); ?>
                                                <button type="submit" class="btn-update" style="background: linear-gradient(135deg, #27ae60 0%, #2ecc71 100%);">Setujui</button>
                                            </form>
                                            <form action="<?php echo e(route('admin.user_roles.reject_admin', $item['id'])); ?>" method="POST" style="display: inline;">
                                                <?php echo csrf_field(); ?>
                                                <button type="submit" class="btn-delete" style="background: linear-gradient(135deg, #e74c3c 0%, #c0392b 100%);">Tolak</button>
                                            </form>
                                        <?php endif; ?>
                                        <button type="button" class="btn-delete" onclick="confirmDelete('<?php echo e($item['id']); ?>', '<?php echo e($item['name']); ?>', 'admin')">Hapus</button>
                                    <?php endif; ?>
                                </div>
                            </td>
                        </tr>
...
<?php /**PATH C:\laravel\PKL BPS TEGAL\resources\views/admin/user_roles/index.blade.php ENDPATH**/ ?>
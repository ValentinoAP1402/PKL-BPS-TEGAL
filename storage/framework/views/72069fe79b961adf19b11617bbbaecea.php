    ...
    <div class="container">
        <div class="welcome-section">
            <div class="welcome-content">
                <h1> Selamat datang, <?php echo e(Auth::guard('admin')->user()->username); ?>!</h1>
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-content">
                    <div class="stat-value"><?php echo e($total_pendaftar); ?></div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-content">
                    <div class="stat-value"><?php echo e($kuota_bulan_ini); ?></div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-content">
                    <div class="stat-value"><?php echo e($total_kuota_tersedia); ?></div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-content">
                    <div class="stat-value"><?php echo e($surat_mitra); ?></div>
        ...
        <div class="actions-section">
            ...
            <div class="actions">
                <a href="<?php echo e(route('admin.pendaftarans.index')); ?>" class="action-card">
                    <span class="action-arrow">→</span>
                    <div class="action-header">
                         <div class="action-icon">
                            <img src="<?php echo e(asset('image/people.png')); ?>" alt="Icon PKL" style="width: 40px; height: 40px;">
                        </div>
                    </div>
                ...
                <a href="<?php echo e(route('admin.kuotas.index')); ?>" class="action-card">
                    <span class="action-arrow">→</span>
                    <div class="action-header">
                        <div class="action-icon">
                            <img src="<?php echo e(asset('image/date.png')); ?>" alt="Icon PKL" style="width: 40px; height: 40px;">
                        </div>
                    </div>
                ...
                <a href="<?php echo e(route('admin.surat_mitra')); ?>" class="action-card">
                    <span class="action-arrow">→</span>
                    <div class="action-header">
                        <div class="action-icon">
                            <img src="<?php echo e(asset('image/letter.png')); ?>" alt="Icon PKL" style="width: 40px; height: 40px;">
                        </div>
                    </div>
                ...
                <a href="<?php echo e(route('admin.alumni_pkl.index')); ?>" class="action-card">
                    <span class="action-arrow">→</span>
                    <div class="action-header">
                        <div class="action-icon">
                            <img src="<?php echo e(asset('image/photo.png')); ?>" alt="Icon PKL" style="width: 40px; height: 40px;">
                        </div>
                    </div>
                ...
                <a href="<?php echo e(route('admin.user_roles.index')); ?>" class="action-card">
                    <span class="action-arrow">→</span>
                    <span class="super-admin-badge" style="position: absolute; top: 20px; right: 20px;">Super Admin</span>
                    <div class="action-header">
                        <div class="action-icon">
                            <img src="<?php echo e(asset('image/user.png')); ?>" alt="Icon PKL" style="width: 40px; height: 40px;">
                        </div>
                    </div>
...
</html><?php /**PATH C:\laravel\PKL BPS TEGAL\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>
...
<body>
    ...
    <div class="container">
        <div class="header-section">
            ...
            <a href="<?php echo e(route('admin.alumni_pkl.create')); ?>" class="add-btn">Tambah Alumni Baru</a>
        </div>
        ...
        <?php if($alumni->count() > 0): ?>
            <div class="alumni-grid">
                ...
                <div class="alumni-card">
                    <img src="<?php echo e(Storage::url($item->foto)); ?>" alt="<?php echo e($item->nama_lengkap); ?>" class="alumni-image">
                    <div class="alumni-content">
                        <div class="alumni-name"><?php echo e($item->nama_lengkap); ?></div>
                        <div class="alumni-university"><?php echo e($item->universitas); ?></div>
                        <div class="alumni-status <?php echo e($item->is_active ? 'status-active' : 'status-inactive'); ?>">
                            <?php echo e($item->is_active ? '✅ Aktif' : '❌ Tidak Aktif'); ?>

                        </div>
                        <div class="alumni-actions">
                            <a href="<?php echo e(route('admin.alumni_pkl.edit', $item->id)); ?>" class="action-btn edit-btn">Edit</a>
                            <form method="POST" action="<?php echo e(route('admin.alumni_pkl.toggle_status', $item->id)); ?>" style="display: inline; flex: 1;">
                                <?php echo csrf_field(); ?>
                            ...
                            <form method="POST" action="<?php echo e(route('admin.alumni_pkl.destroy', $item->id)); ?>" style="display: inline; flex: 1;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus alumni ini?')">
                                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\laravel\PKL BPS TEGAL\resources\views/admin/alumni_pkl/index.blade.php ENDPATH**/ ?>
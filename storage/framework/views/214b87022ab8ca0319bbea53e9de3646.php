...
<body>
    ...
    <div class="container">
        ...
        <form action="<?php echo e(route('pendaftaran.store')); ?>" method="POST" enctype="multipart/form-data" novalidate>
            <?php echo csrf_field(); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" id="nama_lengkap" name="nama_lengkap" value="<?php echo e(old('nama_lengkap')); ?>" placeholder="Masukkan nama lengkap Anda" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" id="asal_sekolah" name="asal_sekolah" value="<?php echo e(old('asal_sekolah')); ?>" placeholder="Contoh: Universitas Indonesia" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" id="jurusan" name="jurusan" value="<?php echo e(old('jurusan')); ?>" placeholder="Contoh: Statistika" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <?php else: ?>
                <div class="form-group">
                    ...
                    <input type="email" id="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="email@example.com" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" id="no_hp" name="no_hp" value="<?php echo e(old('no_hp')); ?>" placeholder="08xxxxxxxxxx" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="date-grid">
                <div class="form-group">
                    ...
                    <input type="date" id="tanggal_mulai_pkl" name="tanggal_mulai_pkl" value="<?php echo e(old('tanggal_mulai_pkl')); ?>" required onchange="checkQuotaAvailability()" lang="id">
                    <?php $__errorArgs = ['tanggal_mulai_pkl'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="tanggal_selesai_pkl" name="tanggal_selesai_pkl" value="<?php echo e(old('tanggal_selesai_pkl')); ?>" required lang="id">
                    <?php $__errorArgs = ['tanggal_selesai_pkl'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <?php $__errorArgs = ['surat_keterangan_pkl'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
</html><?php /**PATH C:\laravel\PKL BPS TEGAL\resources\views/pendaftaran/form.blade.php ENDPATH**/ ?>
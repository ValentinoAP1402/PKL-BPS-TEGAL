...
<body>
    <div class="navbar">
        <div class="navbar-content">
            ...
            <a href="<?php echo e(route('admin.pendaftarans.index')); ?>" class="back-link">Kembali</a>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <?php if($pendaftaran): ?>
            <div class="detail-card">
                ...
                <div class="detail-grid">
                    <div class="detail-item">
                        ...
                        <span class="detail-value"><?php echo e($pendaftaran->id); ?></span>
                    </div>
                    
                    <div class="detail-item">
                        <span class="detail-label"> Nama Lengkap:</span>
                        <span class="detail-value"><strong><?php echo e($pendaftaran->nama_lengkap); ?></strong></span>
                    </div>
                    
                    <div class="detail-item">
                        <span class="detail-label"> Asal Universitas/Sekolah:</span>
                        <span class="detail-value"><?php echo e($pendaftaran->asal_sekolah); ?></span>
                    </div>
                    
                    <div class="detail-item">
                        <span class="detail-label"> Jurusan:</span>
                        <span class="detail-value"><?php echo e($pendaftaran->jurusan); ?></span>
                    </div>
                    
                    <div class="detail-item">
                        <span class="detail-label"> Email:</span>
                        <span class="detail-value"><?php echo e($pendaftaran->email); ?></span>
                    </div>
                    
                    <div class="detail-item">
                        <span class="detail-label"> Nomor HP:</span>
                        <span class="detail-value"><?php echo e($pendaftaran->no_hp); ?></span>
                    </div>
                    
                    <div class="detail-item">
                        <span class="detail-label"> Tanggal Mulai PKL:</span>
                        <span class="detail-value"><?php echo e($pendaftaran->tanggal_mulai_pkl); ?></span>
                    </div>
                    
                    <div class="detail-item">
                        <span class="detail-label"> Tanggal Selesai PKL:</span>
                        <span class="detail-value"><?php echo e($pendaftaran->tanggal_selesai_pkl); ?></span>
                    </div>
                    ...
                    <div class="detail-item">
                        ...
                        <span class="detail-value">
                            <?php if($pendaftaran->surat_keterangan_pkl): ?>
                                <a href="<?php echo e(Storage::url($pendaftaran->surat_keterangan_pkl)); ?>" target="_blank" class="file-link">
                                    Lihat File
                                </a>
                            <?php else: ?>
                    ...
                    <div class="detail-item">
                        ...
                        <span class="detail-value"><?php echo e($pendaftaran->created_at->format('d M Y H:i')); ?></span>
                    </div>
                    
                    <div class="detail-item">
                        <span class="detail-label"> Terakhir Diperbarui:</span>
                        <span class="detail-value"><?php echo e($pendaftaran->updated_at->format('d M Y H:i')); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="upload-section">
                ...
                <?php if($pendaftaran->surat_balasan_pkl): ?>
                    <div class="current-file">
                        ...
                        <div style="display: flex; gap: 8px; flex-wrap: wrap;">
                            <a href="<?php echo e(Storage::url($pendaftaran->surat_balasan_pkl)); ?>" target="_blank" class="file-link" style="margin: 0;">
                                Lihat File
                            </a>
                            <form action="<?php echo e(route('admin.pendaftarans.deleteSuratBalasan', $pendaftaran->id)); ?>" method="POST" style="display: inline;" onsubmit="return confirm('⚠️ PERINGATAN: Hapus Surat Balasan PKL\n\n📌 Pendaftar: <?php echo e($pendaftaran->nama_lengkap); ?>\n🏫 Sekolah: <?php echo e($pendaftaran->asal_sekolah); ?>\n\n❌ Aksi ini akan:\n• Menghapus file surat balasan PKL\n• Data pendaftar tetap tersimpan\n• Tidak dapat dibatalkan\n\n💡 Anda dapat upload ulang file baru setelah dihapus.\n\nApakah Anda yakin ingin menghapus surat balasan ini?')">
                                <?php echo csrf_field(); ?>
                ...
                <?php else: ?>
                    <form action="<?php echo e(route('admin.pendaftarans.uploadSuratBalasan', $pendaftaran->id)); ?>" method="POST" enctype="multipart/form-data" class="upload-form">  
                        <?php echo csrf_field(); ?>
                        <div>
            ...
            <div class="action-section">
                ...
                <?php if($pendaftaran->status === 'pending'): ?>
                    <div class="actions">
                        <button type="button" class="approve" onclick="showModal('approve', <?php echo e($pendaftaran->id); ?>, '<?php echo e(addslashes($pendaftaran->nama_lengkap)); ?>', '<?php echo e(addslashes($pendaftaran->asal_sekolah)); ?>', '<?php echo e($pendaftaran->status); ?>')">Approve</button>
                        <button type="button" class="reject" onclick="showModal('reject', <?php echo e($pendaftaran->id); ?>, '<?php echo e(addslashes($pendaftaran->nama_lengkap)); ?>', '<?php echo e(addslashes($pendaftaran->asal_sekolah)); ?>', '<?php echo e($pendaftaran->status); ?>')">Reject</button>
                        <button type="button" class="delete" onclick="showModal('delete', <?php echo e($pendaftaran->id); ?>, '<?php echo e(addslashes($pendaftaran->nama_lengkap)); ?>', '<?php echo e(addslashes($pendaftaran->asal_sekolah)); ?>', '<?php echo e($pendaftaran->status); ?>')">Hapus</button>
                    </div>
...
<?php /**PATH C:\laravel\PKL BPS TEGAL\resources\views/admin/pendaftarans/show.blade.php ENDPATH**/ ?>
    ...
    <nav id="navbar" class="p-4">
        <div class="container mx-auto flex justify-between items-center px-4">
            ...
            <div class="nav-menu" id="navMenu">
                ...
                <?php if(Auth::check() && (!$pendaftaranStatus || $pendaftaranStatus !== 'approved')): ?>
                    <a href="<?php echo e(route('pendaftaran.create')); ?>" class="nav-link">Daftar Sekarang</a>
                    <a href="<?php echo e($pendaftaranStatus ? route('upload.surat.tanda.tangan') : 'javascript:void(0)'); ?>" class="nav-link" onclick="<?php echo e(!$pendaftaranStatus ? "showRegistrationAlert('upload'); return false;" : ''); ?>">Upload Surat</a>
                    <a href="<?php echo e($pendaftaranStatus ? route('pendaftaran.surat_mitra_signed') : 'javascript:void(0)'); ?>" class="nav-link relative" onclick="<?php echo e(!$pendaftaranStatus ? "showRegistrationAlert('surat_mitra'); return false;" : ''); ?>">
                        Surat Balasan
            ...
            <div class="info-section animate-fade-in-up delay-200">
                ...
                <ol class="custom-ol">
                    ...
                    <li>
                        ...
                        <?php if(Auth::check() && $pendaftaranStatus === 'approved'): ?>
                            <a href="javascript:void(0)" onclick="showApprovedAlert()" class="btn-link">Daftar Sekarang</a>.
                        <?php else: ?>
                            <a href="<?php echo e(route('pendaftaran.create')); ?>" class="btn-link">Daftar Sekarang</a>.
                        <?php endif; ?>
                    </li>
                    <li>
                ...
                <div style="text-align: center; margin-top: 40px;">
                    <?php if(Auth::check() && (!$pendaftaranStatus || $pendaftaranStatus !== 'approved')): ?>
                        <a href="<?php echo e(route('pendaftaran.create')); ?>" class="btn-primary">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('auth.google')); ?>" class="btn-primary">
                ...
                <div class="kuota-grid">
                    <?php $__empty_1 = true; $__currentLoopData = $kuotas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kuota): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="kuota-card">
                            <div class="kuota-card-title"><?php echo e($kuota->bulan); ?></div>
        ...
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="<?php echo e(route('home')); ?>" class="text-gray-400 hover:text-white transition duration-300 flex items-center">→ Beranda</a></li>
                    </ul>
                </div>
            </div>
...
<?php /**PATH C:\laravel\PKL BPS TEGAL\resources\views/informasi.blade.php ENDPATH**/ ?>